    ...
    <div>
      <Link href={href}>
        <div className="relative group ">
          <div className="relative w-64 h-14 opacity-90 overflow-hidden rounded-xl bg-black z-10  cursor-crosshair ">
            ...
            <div className="absolute flex items-center justify-center text-white z-[1] opacity-90 rounded-2xl inset-0.5 bg-black">
              <button
                name="text"
                className="input font-semibold text-lg cursor-crosshair h-full opacity-90 w-full px-16 py-3 rounded-xl text-nowrap  bg-black"
              >
                {label}
              </button>
            </div>
