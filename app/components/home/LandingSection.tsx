...
const LandingSection: React.FC = () => {
  return (
    <section className="bg-[url(/landingline.png)] dark:bg-[url(/landinglinedark.png)]  mx-auto flex flex-col lg:flex-row items-center justify-between px-10 lg:px-20 py-20 lg:py-10 overflow-hidden">
      {/* Foreground Content */}
