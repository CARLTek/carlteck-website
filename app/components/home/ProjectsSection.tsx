...
const ProjectSection = () => {
  ...
  return (
    <section className="bg-[url(/productsbackground.png)] dark:bg-[url(/productsbackgrounddark.png)]  bg-no-repeat bg-contain bg-opacity-10 mx-auto flex flex-col lg:flex-row items-center justify-between py-10 px-10 lg:px-20 gap-20">
      {/* Left Side */}
